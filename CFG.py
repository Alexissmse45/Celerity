cfg = {
    ...
    "<global_dec_after>": [["<data_type>", "identifier", "<declaration_after>"],
    ...
    "<loop_statement>": [
        ["for", "(", "identifier", "<arithmetic_expression>", ";", "<condition>", ";", "identifier", "<inc_dec_operator>", ")", "{", "<statement_set>", "}"],
